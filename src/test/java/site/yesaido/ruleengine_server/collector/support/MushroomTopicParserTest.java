...
class MushroomTopicParserTest {
    ...
    private final String topic = "mushroom/장소/위치/device_model/device_eui/temperature";
    ...
    void test_parse_success() {
        String payload = "{\"value\":995.9,\"time\":\"2026-07-10T08:26:17.922+00:00\",\"device_name\":\"AM107-067999\",\"device_eui\":\"24e124128c067999\"}";
        ...
        Assertions.assertEquals(SensorType.TEMPERATURE, dto.getSensorType());
    ...
    void test_parse_fail_throwInvalidPayloadFormatException() {
        Assertions.assertAll(
                ...
                () -> Assertions.assertThrows(InvalidPayloadFormatException.class,
                        () -> parser.parse(topic, "{\"vale\":995.9,\"time\":\"2026-07-10T08:26:17.922+00:00\",\"device_name\":\"AM107-067999\",\"device_eui\":\"24e124128c067999\"}")),
                // 페이로드 끝에 "}"가 빠짐
                () -> Assertions.assertThrows(InvalidPayloadFormatException.class,
